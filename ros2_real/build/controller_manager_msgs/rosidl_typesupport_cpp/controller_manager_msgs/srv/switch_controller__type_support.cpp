...
static const _SwitchController_Event_type_support_symbol_names_t _SwitchController_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_manager_msgs, srv, SwitchController_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller_manager_msgs, srv, SwitchController_Event)),
  }
};
...
{
  return &::controller_manager_msgs::srv::rosidl_typesupport_cpp::SwitchController_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controller_manager_msgs, srv, SwitchController_Event)() {
  return get_message_type_support_handle<controller_manager_msgs::srv::SwitchController_Event>();
}
...
static const rosidl_service_type_support_t SwitchController_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<controller_manager_msgs::srv::SwitchController_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<controller_manager_msgs::srv::SwitchController_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<controller_manager_msgs::srv::SwitchController_Event>(),
