...
inline void to_flow_style_yaml(
  const ListHardwareComponents_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const ListHardwareComponents_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use controller_manager_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const controller_manager_msgs::srv::ListHardwareComponents_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  controller_manager_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use controller_manager_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const controller_manager_msgs::srv::ListHardwareComponents_Event & msg)
{
  return controller_manager_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<controller_manager_msgs::srv::ListHardwareComponents_Event>()
{
  return "controller_manager_msgs::srv::ListHardwareComponents_Event";
}

template<>
inline const char * name<controller_manager_msgs::srv::ListHardwareComponents_Event>()
{
  return "controller_manager_msgs/srv/ListHardwareComponents_Event";
}

template<>
struct has_fixed_size<controller_manager_msgs::srv::ListHardwareComponents_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<controller_manager_msgs::srv::ListHardwareComponents_Event>
  : std::integral_constant<bool, has_bounded_size<controller_manager_msgs::srv::ListHardwareComponents_Request>::value && has_bounded_size<controller_manager_msgs::srv::ListHardwareComponents_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<controller_manager_msgs::srv::ListHardwareComponents_Event>
  : std::true_type {};
