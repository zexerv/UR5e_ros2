...
class Init_UnloadController_Event_response
{
public:
  explicit Init_UnloadController_Event_response(::controller_manager_msgs::srv::UnloadController_Event & msg)
  : msg_(msg)
  {}
  ::controller_manager_msgs::srv::UnloadController_Event response(::controller_manager_msgs::srv::UnloadController_Event::_response_type arg)
  {
...
private:
  ::controller_manager_msgs::srv::UnloadController_Event msg_;
};

class Init_UnloadController_Event_request
{
public:
  explicit Init_UnloadController_Event_request(::controller_manager_msgs::srv::UnloadController_Event & msg)
  : msg_(msg)
  {}
  Init_UnloadController_Event_response request(::controller_manager_msgs::srv::UnloadController_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_UnloadController_Event_response(msg_);
  }
...
class Init_UnloadController_Event_info
{
public:
  Init_UnloadController_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_UnloadController_Event_request info(::controller_manager_msgs::srv::UnloadController_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_UnloadController_Event_request(msg_);
  }
...
template<>
inline
auto build<::controller_manager_msgs::srv::UnloadController_Event>()
{
  return controller_manager_msgs::srv::builder::Init_UnloadController_Event_info();
}
