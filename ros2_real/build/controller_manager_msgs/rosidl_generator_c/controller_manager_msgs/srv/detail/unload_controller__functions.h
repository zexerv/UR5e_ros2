...
#ifndef CONTROLLER_MANAGER_MSGS__SRV__DETAIL__UNLOAD_CONTROLLER__FUNCTIONS_H_
#define CONTROLLER_MANAGER_MSGS__SRV__DETAIL__UNLOAD_CONTROLLER__FUNCTIONS_H_
...
/// Initialize srv/UnloadController message.
/**
...
/// Finalize srv/UnloadController message.
/**
...
/// Create srv/UnloadController message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * controller_manager_msgs__srv__UnloadController_Request__init().
...
/// Destroy srv/UnloadController message.
/**
 * It calls
 * controller_manager_msgs__srv__UnloadController_Request__fini()
...
/// Check for srv/UnloadController message equality.
/**
...
/// Copy a srv/UnloadController message.
/**
...
/// Initialize array of srv/UnloadController messages.
/**
...
/// Finalize array of srv/UnloadController messages.
/**
 * It calls
 * controller_manager_msgs__srv__UnloadController_Request__fini()
...
/// Create array of srv/UnloadController messages.
/**
 * It allocates the memory for the array and calls
 * controller_manager_msgs__srv__UnloadController_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/UnloadController messages.
/**
 * It calls
 * controller_manager_msgs__srv__UnloadController_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/UnloadController message array equality.
/**
...
/// Copy an array of srv/UnloadController messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * controller_manager_msgs__srv__UnloadController_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
...
/**
 * It calls
 * controller_manager_msgs__srv__UnloadController_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
...
/**
 * It allocates the memory for the array and calls
 * controller_manager_msgs__srv__UnloadController_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
...
/**
 * It calls
 * controller_manager_msgs__srv__UnloadController_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * controller_manager_msgs__srv__UnloadController_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
bool
controller_manager_msgs__srv__UnloadController_Event__init(controller_manager_msgs__srv__UnloadController_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
void
controller_manager_msgs__srv__UnloadController_Event__fini(controller_manager_msgs__srv__UnloadController_Event * msg);

/// Create srv/UnloadController message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * controller_manager_msgs__srv__UnloadController_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
...
/**
 * It calls
 * controller_manager_msgs__srv__UnloadController_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
void
controller_manager_msgs__srv__UnloadController_Event__destroy(controller_manager_msgs__srv__UnloadController_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
bool
controller_manager_msgs__srv__UnloadController_Event__are_equal(const controller_manager_msgs__srv__UnloadController_Event * lhs, const controller_manager_msgs__srv__UnloadController_Event * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
bool
controller_manager_msgs__srv__UnloadController_Event__copy(
  const controller_manager_msgs__srv__UnloadController_Event * input,
  controller_manager_msgs__srv__UnloadController_Event * output);
...
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
bool
controller_manager_msgs__srv__UnloadController_Event__Sequence__init(controller_manager_msgs__srv__UnloadController_Event__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
void
controller_manager_msgs__srv__UnloadController_Event__Sequence__fini(controller_manager_msgs__srv__UnloadController_Event__Sequence * array);

/// Create array of srv/UnloadController messages.
/**
 * It allocates the memory for the array and calls
 * controller_manager_msgs__srv__UnloadController_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
controller_manager_msgs__srv__UnloadController_Event__Sequence *
controller_manager_msgs__srv__UnloadController_Event__Sequence__create(size_t size);

/// Destroy array of srv/UnloadController messages.
/**
 * It calls
 * controller_manager_msgs__srv__UnloadController_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
void
controller_manager_msgs__srv__UnloadController_Event__Sequence__destroy(controller_manager_msgs__srv__UnloadController_Event__Sequence * array);
...
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
bool
controller_manager_msgs__srv__UnloadController_Event__Sequence__are_equal(const controller_manager_msgs__srv__UnloadController_Event__Sequence * lhs, const controller_manager_msgs__srv__UnloadController_Event__Sequence * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_controller_manager_msgs
bool
controller_manager_msgs__srv__UnloadController_Event__Sequence__copy(
  const controller_manager_msgs__srv__UnloadController_Event__Sequence * input,
  controller_manager_msgs__srv__UnloadController_Event__Sequence * output);
#ifdef __cplusplus
}
#endif

#endif  // CONTROLLER_MANAGER_MSGS__SRV__DETAIL__UNLOAD_CONTROLLER__FUNCTIONS_H_
