...
using _ListHardwareComponents_Event__ros_msg_type = controller_manager_msgs__srv__ListHardwareComponents_Event;

static bool _ListHardwareComponents_Event__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  if (!untyped_ros_message) {
  ...
  const _ListHardwareComponents_Event__ros_msg_type * ros_message = static_cast<const _ListHardwareComponents_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, controller_manager_msgs, srv, ListHardwareComponents_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, controller_manager_msgs, srv, ListHardwareComponents_Response
      )()->data);
...
static bool _ListHardwareComponents_Event__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  if (!untyped_ros_message) {
  ...
  _ListHardwareComponents_Event__ros_msg_type * ros_message = static_cast<_ListHardwareComponents_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence__fini(&ros_message->request);
    }
    if (!controller_manager_msgs__srv__ListHardwareComponents_Request__Sequence__init(&ros_message->request, size)) {
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence__fini(&ros_message->response);
    }
    if (!controller_manager_msgs__srv__ListHardwareComponents_Response__Sequence__init(&ros_message->response, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_manager_msgs
size_t get_serialized_size_controller_manager_msgs__srv__ListHardwareComponents_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ListHardwareComponents_Event__ros_msg_type * ros_message = static_cast<const _ListHardwareComponents_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_controller_manager_msgs__srv__ListHardwareComponents_Request(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_controller_manager_msgs__srv__ListHardwareComponents_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _ListHardwareComponents_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_controller_manager_msgs__srv__ListHardwareComponents_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_controller_manager_msgs
size_t max_serialized_size_controller_manager_msgs__srv__ListHardwareComponents_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_controller_manager_msgs__srv__ListHardwareComponents_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_controller_manager_msgs__srv__ListHardwareComponents_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = controller_manager_msgs__srv__ListHardwareComponents_Event;
    is_plain =
      (
...
static size_t _ListHardwareComponents_Event__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_controller_manager_msgs__srv__ListHardwareComponents_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_ListHardwareComponents_Event = {
  "controller_manager_msgs::srv",
  "ListHardwareComponents_Event",
  _ListHardwareComponents_Event__cdr_serialize,
  _ListHardwareComponents_Event__cdr_deserialize,
  _ListHardwareComponents_Event__get_serialized_size,
  _ListHardwareComponents_Event__max_serialized_size
};

static rosidl_message_type_support_t _ListHardwareComponents_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ListHardwareComponents_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, controller_manager_msgs, srv, ListHardwareComponents_Event)() {
  return &_ListHardwareComponents_Event__type_support;
}
...
static rosidl_service_type_support_t ListHardwareComponents__handle = {
  ...
  &_ListHardwareComponents_Request__type_support,
  &_ListHardwareComponents_Response__type_support,
  &_ListHardwareComponents_Event__type_support,
