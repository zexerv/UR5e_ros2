...
typedef struct _GripperCommand_SendGoal_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _GripperCommand_SendGoal_Event_type_support_ids_t;

static const _GripperCommand_SendGoal_Event_type_support_ids_t _GripperCommand_SendGoal_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _GripperCommand_SendGoal_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _GripperCommand_SendGoal_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _GripperCommand_SendGoal_Event_type_support_symbol_names_t _GripperCommand_SendGoal_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, action, GripperCommand_SendGoal_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_msgs, action, GripperCommand_SendGoal_Event)),
  }
};

typedef struct _GripperCommand_SendGoal_Event_type_support_data_t
{
  void * data[2];
} _GripperCommand_SendGoal_Event_type_support_data_t;

static _GripperCommand_SendGoal_Event_type_support_data_t _GripperCommand_SendGoal_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _GripperCommand_SendGoal_Event_message_typesupport_map = {
  2,
  "control_msgs",
  &_GripperCommand_SendGoal_Event_message_typesupport_ids.typesupport_identifier[0],
  &_GripperCommand_SendGoal_Event_message_typesupport_symbol_names.symbol_name[0],
  &_GripperCommand_SendGoal_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t GripperCommand_SendGoal_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_GripperCommand_SendGoal_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::control_msgs::action::rosidl_typesupport_cpp::GripperCommand_SendGoal_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, control_msgs, action, GripperCommand_SendGoal_Event)() {
  return get_message_type_support_handle<control_msgs::action::GripperCommand_SendGoal_Event>();
}
...
static const rosidl_service_type_support_t GripperCommand_SendGoal_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<control_msgs::action::GripperCommand_SendGoal_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<control_msgs::action::GripperCommand_SendGoal_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<control_msgs::action::GripperCommand_SendGoal_Event>(),
...
typedef struct _GripperCommand_GetResult_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _GripperCommand_GetResult_Event_type_support_ids_t;

static const _GripperCommand_GetResult_Event_type_support_ids_t _GripperCommand_GetResult_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _GripperCommand_GetResult_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _GripperCommand_GetResult_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _GripperCommand_GetResult_Event_type_support_symbol_names_t _GripperCommand_GetResult_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, action, GripperCommand_GetResult_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_msgs, action, GripperCommand_GetResult_Event)),
  }
};

typedef struct _GripperCommand_GetResult_Event_type_support_data_t
{
  void * data[2];
} _GripperCommand_GetResult_Event_type_support_data_t;

static _GripperCommand_GetResult_Event_type_support_data_t _GripperCommand_GetResult_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _GripperCommand_GetResult_Event_message_typesupport_map = {
  2,
  "control_msgs",
  &_GripperCommand_GetResult_Event_message_typesupport_ids.typesupport_identifier[0],
  &_GripperCommand_GetResult_Event_message_typesupport_symbol_names.symbol_name[0],
  &_GripperCommand_GetResult_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t GripperCommand_GetResult_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_GripperCommand_GetResult_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::control_msgs::action::rosidl_typesupport_cpp::GripperCommand_GetResult_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, control_msgs, action, GripperCommand_GetResult_Event)() {
  return get_message_type_support_handle<control_msgs::action::GripperCommand_GetResult_Event>();
}
...
static const rosidl_service_type_support_t GripperCommand_GetResult_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_service_typesupport_handle_function,
  ::rosidl_typesupport_cpp::get_message_type_support_handle<control_msgs::action::GripperCommand_GetResult_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<control_msgs::action::GripperCommand_GetResult_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<control_msgs::action::GripperCommand_GetResult_Event>(),
