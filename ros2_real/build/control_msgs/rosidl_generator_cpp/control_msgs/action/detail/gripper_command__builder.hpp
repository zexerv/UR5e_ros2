...
class Init_GripperCommand_SendGoal_Event_response
{
public:
  explicit Init_GripperCommand_SendGoal_Event_response(::control_msgs::action::GripperCommand_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::control_msgs::action::GripperCommand_SendGoal_Event response(::control_msgs::action::GripperCommand_SendGoal_Event::_response_type arg)
  {
...
private:
  ::control_msgs::action::GripperCommand_SendGoal_Event msg_;
};

class Init_GripperCommand_SendGoal_Event_request
{
public:
  explicit Init_GripperCommand_SendGoal_Event_request(::control_msgs::action::GripperCommand_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_GripperCommand_SendGoal_Event_response request(::control_msgs::action::GripperCommand_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GripperCommand_SendGoal_Event_response(msg_);
  }
...
class Init_GripperCommand_SendGoal_Event_info
{
public:
  Init_GripperCommand_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GripperCommand_SendGoal_Event_request info(::control_msgs::action::GripperCommand_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GripperCommand_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::control_msgs::action::GripperCommand_SendGoal_Event>()
{
  return control_msgs::action::builder::Init_GripperCommand_SendGoal_Event_info();
}
...
class Init_GripperCommand_GetResult_Event_response
{
public:
  explicit Init_GripperCommand_GetResult_Event_response(::control_msgs::action::GripperCommand_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::control_msgs::action::GripperCommand_GetResult_Event response(::control_msgs::action::GripperCommand_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::control_msgs::action::GripperCommand_GetResult_Event msg_;
};

class Init_GripperCommand_GetResult_Event_request
{
public:
  explicit Init_GripperCommand_GetResult_Event_request(::control_msgs::action::GripperCommand_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_GripperCommand_GetResult_Event_response request(::control_msgs::action::GripperCommand_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GripperCommand_GetResult_Event_response(msg_);
  }
...
class Init_GripperCommand_GetResult_Event_info
{
public:
  Init_GripperCommand_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GripperCommand_GetResult_Event_request info(::control_msgs::action::GripperCommand_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GripperCommand_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::control_msgs::action::GripperCommand_GetResult_Event>()
{
  return control_msgs::action::builder::Init_GripperCommand_GetResult_Event_info();
}
