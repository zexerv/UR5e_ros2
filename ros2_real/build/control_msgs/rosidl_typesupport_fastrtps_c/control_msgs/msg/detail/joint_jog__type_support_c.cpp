...
#include "control_msgs/msg/detail/joint_jog__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // displacements, velocities
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // displacements, velocities
...
using _JointJog__ros_msg_type = control_msgs__msg__JointJog;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _JointJog__ros_msg_type * ros_message = static_cast<const _JointJog__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: displacements
  {
    size_t size = ros_message->displacements.size;
    auto array_ptr = ros_message->displacements.data;
    cdr << static_cast<uint32_t>(size);
  ...
  void * untyped_ros_message)
{
  ...
  _JointJog__ros_msg_type * ros_message = static_cast<_JointJog__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: displacements
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->displacements.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->displacements);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->displacements, size)) {
      fprintf(stderr, "failed to create array for field 'displacements'");
      return false;
    }
    auto array_ptr = ros_message->displacements.data;
...
size_t get_serialized_size_control_msgs__msg__JointJog(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JointJog__ros_msg_type * ros_message = static_cast<const _JointJog__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _JointJog__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_control_msgs__msg__JointJog(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_control_msgs
size_t max_serialized_size_control_msgs__msg__JointJog(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_msgs__msg__JointJog;
    is_plain =
      (
...
static size_t _JointJog__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_control_msgs__msg__JointJog(
...
static message_type_support_callbacks_t __callbacks_JointJog = {
  "control_msgs::msg",
  "JointJog",
...
static rosidl_message_type_support_t _JointJog__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_JointJog,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, control_msgs, msg, JointJog)() {
  return &_JointJog__type_support;
}
