...
#include "control_msgs/msg/detail/multi_dof_state_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const control_msgs::msg::MultiDOFStateStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_msgs::msg::MultiDOFStateStamped & ros_message)
{
  // Member: header
  ...
  // Member: dof_states
  {
    ...
    ros_message.dof_states.resize(size);
    for (size_t i = 0; i < size; i++) {
      control_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.dof_states[i]);
    }
  }
  ...
  // Member: dof_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.dof_states[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_control_msgs
max_serialized_size_MultiDOFStateStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_msgs::msg::MultiDOFStateStamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_msgs::msg::MultiDOFStateStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<control_msgs::msg::MultiDOFStateStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MultiDOFStateStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const control_msgs::msg::MultiDOFStateStamped *>(
...
static size_t _MultiDOFStateStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MultiDOFStateStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MultiDOFStateStamped__callbacks = {
  "control_msgs::msg",
...
static rosidl_message_type_support_t _MultiDOFStateStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MultiDOFStateStamped__callbacks,
...
{
  return &control_msgs::msg::typesupport_fastrtps_cpp::_MultiDOFStateStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, msg, MultiDOFStateStamped)() {
  return &control_msgs::msg::typesupport_fastrtps_cpp::_MultiDOFStateStamped__handle;
}
