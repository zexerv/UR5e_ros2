...
#include "control_msgs/msg/detail/multi_dof_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const control_msgs::msg::MultiDOFCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_msgs::msg::MultiDOFCommand & ros_message)
{
  // Member: dof_names
  {
    cdr >> ros_message.dof_names;
  ...
  size_t current_alignment)
{
  ...
  // Member: values_dot
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.values_dot[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_control_msgs
max_serialized_size_MultiDOFCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_msgs::msg::MultiDOFCommand;
    is_plain =
      (
      offsetof(DataType, values_dot) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const control_msgs::msg::MultiDOFCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<control_msgs::msg::MultiDOFCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MultiDOFCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const control_msgs::msg::MultiDOFCommand *>(
...
static size_t _MultiDOFCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MultiDOFCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MultiDOFCommand__callbacks = {
  "control_msgs::msg",
  "MultiDOFCommand",
...
static rosidl_message_type_support_t _MultiDOFCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MultiDOFCommand__callbacks,
...
{
  return &control_msgs::msg::typesupport_fastrtps_cpp::_MultiDOFCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, msg, MultiDOFCommand)() {
  return &control_msgs::msg::typesupport_fastrtps_cpp::_MultiDOFCommand__handle;
}
