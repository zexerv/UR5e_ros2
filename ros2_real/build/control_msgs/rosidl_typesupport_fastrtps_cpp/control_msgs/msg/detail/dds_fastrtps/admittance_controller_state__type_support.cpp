...
#include "control_msgs/msg/detail/admittance_controller_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
// functions for geometry_msgs::msg::TransformStamped already declared above
...
// functions for geometry_msgs::msg::TwistStamped already declared above
...
cdr_serialize(
  const control_msgs::msg::AdmittanceControllerState & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: stiffness
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.stiffness,
    cdr);
  // Member: rot_base_control
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.rot_base_control,
    cdr);
  // Member: ref_trans_base_ft
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.ref_trans_base_ft,
    cdr);
  // Member: selected_axes
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.selected_axes,
    cdr);
  // Member: ft_sensor_frame
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.ft_sensor_frame,
    cdr);
  // Member: admittance_position
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.admittance_position,
    cdr);
  // Member: admittance_acceleration
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.admittance_acceleration,
    cdr);
  // Member: admittance_velocity
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.admittance_velocity,
    cdr);
  // Member: wrench_base
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.wrench_base,
    cdr);
  // Member: joint_state
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_msgs::msg::AdmittanceControllerState & ros_message)
{
  // Member: mass
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_control_msgs
max_serialized_size_AdmittanceControllerState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_msgs::msg::AdmittanceControllerState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_msgs::msg::AdmittanceControllerState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<control_msgs::msg::AdmittanceControllerState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AdmittanceControllerState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const control_msgs::msg::AdmittanceControllerState *>(
...
static size_t _AdmittanceControllerState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_AdmittanceControllerState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AdmittanceControllerState__callbacks = {
  "control_msgs::msg",
...
static rosidl_message_type_support_t _AdmittanceControllerState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AdmittanceControllerState__callbacks,
...
{
  return &control_msgs::msg::typesupport_fastrtps_cpp::_AdmittanceControllerState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, msg, AdmittanceControllerState)() {
  return &control_msgs::msg::typesupport_fastrtps_cpp::_AdmittanceControllerState__handle;
}
