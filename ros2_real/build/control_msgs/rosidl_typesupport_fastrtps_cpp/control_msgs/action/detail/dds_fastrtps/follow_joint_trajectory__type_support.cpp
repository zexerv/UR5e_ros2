...
// functions for control_msgs::action::FollowJointTrajectory_SendGoal_Request already declared above

// functions for control_msgs::action::FollowJointTrajectory_SendGoal_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_control_msgs
cdr_serialize(
  const control_msgs::action::FollowJointTrajectory_SendGoal_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_msgs::action::FollowJointTrajectory_SendGoal_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_control_msgs
max_serialized_size_FollowJointTrajectory_SendGoal_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        control_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_FollowJointTrajectory_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        control_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_FollowJointTrajectory_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = control_msgs::action::FollowJointTrajectory_SendGoal_Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_msgs::action::FollowJointTrajectory_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<control_msgs::action::FollowJointTrajectory_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FollowJointTrajectory_SendGoal_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const control_msgs::action::FollowJointTrajectory_SendGoal_Event *>(
...
static size_t _FollowJointTrajectory_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FollowJointTrajectory_SendGoal_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FollowJointTrajectory_SendGoal_Event__callbacks = {
  "control_msgs::action",
...
static rosidl_message_type_support_t _FollowJointTrajectory_SendGoal_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FollowJointTrajectory_SendGoal_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &control_msgs::action::typesupport_fastrtps_cpp::_FollowJointTrajectory_SendGoal_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, action, FollowJointTrajectory_SendGoal_Event)() {
  return &control_msgs::action::typesupport_fastrtps_cpp::_FollowJointTrajectory_SendGoal_Event__handle;
}
...
static const rosidl_service_type_support_t _FollowJointTrajectory_SendGoal__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FollowJointTrajectory_SendGoal__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<control_msgs::action::FollowJointTrajectory_SendGoal_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<control_msgs::action::FollowJointTrajectory_SendGoal_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<control_msgs::action::FollowJointTrajectory_SendGoal_Event>(),
...
// functions for control_msgs::action::FollowJointTrajectory_GetResult_Request already declared above

// functions for control_msgs::action::FollowJointTrajectory_GetResult_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_control_msgs
cdr_serialize(
  const control_msgs::action::FollowJointTrajectory_GetResult_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  control_msgs::action::FollowJointTrajectory_GetResult_Event & ros_message)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.info);
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_control_msgs
max_serialized_size_FollowJointTrajectory_GetResult_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        control_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_FollowJointTrajectory_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        control_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_FollowJointTrajectory_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = control_msgs::action::FollowJointTrajectory_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const control_msgs::action::FollowJointTrajectory_GetResult_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<control_msgs::action::FollowJointTrajectory_GetResult_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FollowJointTrajectory_GetResult_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const control_msgs::action::FollowJointTrajectory_GetResult_Event *>(
...
static size_t _FollowJointTrajectory_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FollowJointTrajectory_GetResult_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FollowJointTrajectory_GetResult_Event__callbacks = {
  "control_msgs::action",
...
static rosidl_message_type_support_t _FollowJointTrajectory_GetResult_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FollowJointTrajectory_GetResult_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &control_msgs::action::typesupport_fastrtps_cpp::_FollowJointTrajectory_GetResult_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, control_msgs, action, FollowJointTrajectory_GetResult_Event)() {
  return &control_msgs::action::typesupport_fastrtps_cpp::_FollowJointTrajectory_GetResult_Event__handle;
}
...
static const rosidl_service_type_support_t _FollowJointTrajectory_GetResult__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FollowJointTrajectory_GetResult__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<control_msgs::action::FollowJointTrajectory_GetResult_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<control_msgs::action::FollowJointTrajectory_GetResult_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<control_msgs::action::FollowJointTrajectory_GetResult_Event>(),
