...
enum
{
  ur_dashboard_msgs__action__SetMode_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ur_dashboard_msgs__action__SetMode_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/SetMode in the package ur_dashboard_msgs.
typedef struct ur_dashboard_msgs__action__SetMode_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ur_dashboard_msgs__action__SetMode_SendGoal_Request__Sequence request;
  ur_dashboard_msgs__action__SetMode_SendGoal_Response__Sequence response;
} ur_dashboard_msgs__action__SetMode_SendGoal_Event;

// Struct for a sequence of ur_dashboard_msgs__action__SetMode_SendGoal_Event.
typedef struct ur_dashboard_msgs__action__SetMode_SendGoal_Event__Sequence
{
  ur_dashboard_msgs__action__SetMode_SendGoal_Event * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
...
enum
{
  ur_dashboard_msgs__action__SetMode_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ur_dashboard_msgs__action__SetMode_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/SetMode in the package ur_dashboard_msgs.
typedef struct ur_dashboard_msgs__action__SetMode_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ur_dashboard_msgs__action__SetMode_GetResult_Request__Sequence request;
  ur_dashboard_msgs__action__SetMode_GetResult_Response__Sequence response;
} ur_dashboard_msgs__action__SetMode_GetResult_Event;

// Struct for a sequence of ur_dashboard_msgs__action__SetMode_GetResult_Event.
typedef struct ur_dashboard_msgs__action__SetMode_GetResult_Event__Sequence
{
  ur_dashboard_msgs__action__SetMode_GetResult_Event * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
