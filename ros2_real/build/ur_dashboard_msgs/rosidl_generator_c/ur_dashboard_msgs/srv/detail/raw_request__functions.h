 ...
 * )) before or use
 * ur_dashboard_msgs__srv__RawRequest_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__RawRequest_Event__init(ur_dashboard_msgs__srv__RawRequest_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__RawRequest_Event__fini(ur_dashboard_msgs__srv__RawRequest_Event * msg);

/// Create srv/RawRequest message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_dashboard_msgs__srv__RawRequest_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
...
/**
 * It calls
 * ur_dashboard_msgs__srv__RawRequest_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__RawRequest_Event__destroy(ur_dashboard_msgs__srv__RawRequest_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__RawRequest_Event__are_equal(const ur_dashboard_msgs__srv__RawRequest_Event * lhs, const ur_dashboard_msgs__srv__RawRequest_Event * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__RawRequest_Event__copy(
  const ur_dashboard_msgs__srv__RawRequest_Event * input,
  ur_dashboard_msgs__srv__RawRequest_Event * output);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__RawRequest_Event__Sequence__init(ur_dashboard_msgs__srv__RawRequest_Event__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__RawRequest_Event__Sequence__fini(ur_dashboard_msgs__srv__RawRequest_Event__Sequence * array);

/// Create array of srv/RawRequest messages.
/**
 * It allocates the memory for the array and calls
 * ur_dashboard_msgs__srv__RawRequest_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
ur_dashboard_msgs__srv__RawRequest_Event__Sequence *
ur_dashboard_msgs__srv__RawRequest_Event__Sequence__create(size_t size);

/// Destroy array of srv/RawRequest messages.
/**
 * It calls
 * ur_dashboard_msgs__srv__RawRequest_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__RawRequest_Event__Sequence__destroy(ur_dashboard_msgs__srv__RawRequest_Event__Sequence * array);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__RawRequest_Event__Sequence__are_equal(const ur_dashboard_msgs__srv__RawRequest_Event__Sequence * lhs, const ur_dashboard_msgs__srv__RawRequest_Event__Sequence * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__RawRequest_Event__Sequence__copy(
  const ur_dashboard_msgs__srv__RawRequest_Event__Sequence * input,
  ur_dashboard_msgs__srv__RawRequest_Event__Sequence * output);
#ifdef __cplusplus
}
#endif
