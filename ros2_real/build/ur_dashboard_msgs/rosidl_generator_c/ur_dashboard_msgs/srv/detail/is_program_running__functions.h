...
#ifndef UR_DASHBOARD_MSGS__SRV__DETAIL__IS_PROGRAM_RUNNING__FUNCTIONS_H_
#define UR_DASHBOARD_MSGS__SRV__DETAIL__IS_PROGRAM_RUNNING__FUNCTIONS_H_
...
/// Initialize srv/IsProgramRunning message.
/**
...
/// Finalize srv/IsProgramRunning message.
/**
...
/// Create srv/IsProgramRunning message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Request__init().
...
/// Destroy srv/IsProgramRunning message.
/**
 * It calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Request__fini()
...
/// Check for srv/IsProgramRunning message equality.
/**
...
/// Copy a srv/IsProgramRunning message.
/**
...
/// Initialize array of srv/IsProgramRunning messages.
/**
...
/// Finalize array of srv/IsProgramRunning messages.
/**
 * It calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Request__fini()
...
/// Create array of srv/IsProgramRunning messages.
/**
 * It allocates the memory for the array and calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/IsProgramRunning messages.
/**
 * It calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/IsProgramRunning message array equality.
/**
...
/// Copy an array of srv/IsProgramRunning messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
...
/**
 * It calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
...
/**
 * It allocates the memory for the array and calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
...
/**
 * It calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * ur_dashboard_msgs__srv__IsProgramRunning_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__IsProgramRunning_Event__init(ur_dashboard_msgs__srv__IsProgramRunning_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__IsProgramRunning_Event__fini(ur_dashboard_msgs__srv__IsProgramRunning_Event * msg);

/// Create srv/IsProgramRunning message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
...
/**
 * It calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__IsProgramRunning_Event__destroy(ur_dashboard_msgs__srv__IsProgramRunning_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__IsProgramRunning_Event__are_equal(const ur_dashboard_msgs__srv__IsProgramRunning_Event * lhs, const ur_dashboard_msgs__srv__IsProgramRunning_Event * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__IsProgramRunning_Event__copy(
  const ur_dashboard_msgs__srv__IsProgramRunning_Event * input,
  ur_dashboard_msgs__srv__IsProgramRunning_Event * output);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__init(ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__fini(ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * array);

/// Create array of srv/IsProgramRunning messages.
/**
 * It allocates the memory for the array and calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence *
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__create(size_t size);

/// Destroy array of srv/IsProgramRunning messages.
/**
 * It calls
 * ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__destroy(ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * array);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__are_equal(const ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * lhs, const ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence__copy(
  const ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * input,
  ur_dashboard_msgs__srv__IsProgramRunning_Event__Sequence * output);
#ifdef __cplusplus
}
#endif

#endif  // UR_DASHBOARD_MSGS__SRV__DETAIL__IS_PROGRAM_RUNNING__FUNCTIONS_H_
