...
#include "ur_dashboard_msgs/msg/detail/safety_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ur_dashboard_msgs::msg::SafetyMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_dashboard_msgs::msg::SafetyMode & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_dashboard_msgs::msg::SafetyMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_dashboard_msgs::msg::SafetyMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_dashboard_msgs::msg::SafetyMode *>(
    untyped_ros_message);
...
static size_t _SafetyMode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SafetyMode(full_bounded, is_plain, 0);
...
{
  return &ur_dashboard_msgs::msg::typesupport_fastrtps_cpp::_SafetyMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_dashboard_msgs, msg, SafetyMode)() {
  return &ur_dashboard_msgs::msg::typesupport_fastrtps_cpp::_SafetyMode__handle;
}
