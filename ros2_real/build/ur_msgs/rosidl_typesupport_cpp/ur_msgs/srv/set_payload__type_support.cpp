...
static const _SetPayload_Event_type_support_symbol_names_t _SetPayload_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_msgs, srv, SetPayload_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_msgs, srv, SetPayload_Event)),
  }
};
...
{
  return &::ur_msgs::srv::rosidl_typesupport_cpp::SetPayload_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_msgs, srv, SetPayload_Event)() {
  return get_message_type_support_handle<ur_msgs::srv::SetPayload_Event>();
}
...
static const rosidl_service_type_support_t SetPayload_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ur_msgs::srv::SetPayload_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ur_msgs::srv::SetPayload_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ur_msgs::srv::SetPayload_Event>(),
