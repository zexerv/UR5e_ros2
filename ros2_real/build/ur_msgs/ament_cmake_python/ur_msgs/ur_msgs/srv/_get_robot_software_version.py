...
class Metaclass_GetRobotSoftwareVersion_Event(type):
    """Metaclass of message 'GetRobotSoftwareVersion_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_robot_software_version__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_robot_software_version__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_robot_software_version__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_robot_software_version__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_robot_software_version__event
...
class GetRobotSoftwareVersion_Event(metaclass=Metaclass_GetRobotSoftwareVersion_Event):
    """Message class 'GetRobotSoftwareVersion_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_msgs/GetRobotSoftwareVersion_Request, 1>',
        'response': 'sequence<ur_msgs/GetRobotSoftwareVersion_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'GetRobotSoftwareVersion_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'GetRobotSoftwareVersion_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_msgs.srv import GetRobotSoftwareVersion_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetRobotSoftwareVersion_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetRobotSoftwareVersion_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ur_msgs.srv import GetRobotSoftwareVersion_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetRobotSoftwareVersion_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetRobotSoftwareVersion_Response'"
...
class Metaclass_GetRobotSoftwareVersion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_robot_software_version.Metaclass_GetRobotSoftwareVersion_Event._TYPE_SUPPORT is None:
                _get_robot_software_version.Metaclass_GetRobotSoftwareVersion_Event.__import_type_support__()
...
class GetRobotSoftwareVersion(metaclass=Metaclass_GetRobotSoftwareVersion):
    ...
    from ur_msgs.srv._get_robot_software_version import GetRobotSoftwareVersion_Event as Event
