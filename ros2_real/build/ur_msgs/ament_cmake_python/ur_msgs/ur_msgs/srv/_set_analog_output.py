...
class Metaclass_SetAnalogOutput_Event(type):
    """Metaclass of message 'SetAnalogOutput_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_analog_output__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_analog_output__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_analog_output__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_analog_output__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_analog_output__event
...
class SetAnalogOutput_Event(metaclass=Metaclass_SetAnalogOutput_Event):
    """Message class 'SetAnalogOutput_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_msgs/SetAnalogOutput_Request, 1>',
        'response': 'sequence<ur_msgs/SetAnalogOutput_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'SetAnalogOutput_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'SetAnalogOutput_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_msgs.srv import SetAnalogOutput_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetAnalogOutput_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetAnalogOutput_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ur_msgs.srv import SetAnalogOutput_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetAnalogOutput_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetAnalogOutput_Response'"
...
class Metaclass_SetAnalogOutput(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_analog_output.Metaclass_SetAnalogOutput_Event._TYPE_SUPPORT is None:
                _set_analog_output.Metaclass_SetAnalogOutput_Event.__import_type_support__()
...
class SetAnalogOutput(metaclass=Metaclass_SetAnalogOutput):
    ...
    from ur_msgs.srv._set_analog_output import SetAnalogOutput_Event as Event
