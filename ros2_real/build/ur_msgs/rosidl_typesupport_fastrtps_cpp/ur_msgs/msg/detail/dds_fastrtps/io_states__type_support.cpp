...
// functions for ur_msgs::msg::Digital already declared above
...
// functions for ur_msgs::msg::Analog already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_msgs::msg::IOStates;
    is_plain =
      (
...
static size_t _IOStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IOStates(full_bounded, is_plain, 0);
