  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_msgs::srv::SetPayload_Request;
    is_plain =
      (
      offsetof(DataType, center_of_gravity) +
      last_member_size
      ) == ret_val;
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_msgs::srv::SetPayload_Response;
    is_plain =
      (
...
// functions for ur_msgs::srv::SetPayload_Request already declared above

// functions for ur_msgs::srv::SetPayload_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ur_msgs
cdr_serialize(
  const ur_msgs::srv::SetPayload_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_msgs::srv::SetPayload_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ur_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetPayload_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ur_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetPayload_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ur_msgs::srv::SetPayload_Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_msgs::srv::SetPayload_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ur_msgs::srv::SetPayload_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_ur_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<ur_msgs::srv::SetPayload_Event>()
{
  return &ur_msgs::srv::typesupport_fastrtps_cpp::_SetPayload_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_msgs, srv, SetPayload_Event)() {
  return &ur_msgs::srv::typesupport_fastrtps_cpp::_SetPayload_Event__handle;
}
...
static const rosidl_service_type_support_t _SetPayload__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ur_msgs::srv::SetPayload_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ur_msgs::srv::SetPayload_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ur_msgs::srv::SetPayload_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<ur_msgs::srv::SetPayload>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<ur_msgs::srv::SetPayload>,
