...
enum
{
  ur_msgs__srv__SetIO_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ur_msgs__srv__SetIO_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetIO in the package ur_msgs.
typedef struct ur_msgs__srv__SetIO_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ur_msgs__srv__SetIO_Request__Sequence request;
  ur_msgs__srv__SetIO_Response__Sequence response;
} ur_msgs__srv__SetIO_Event;

// Struct for a sequence of ur_msgs__srv__SetIO_Event.
typedef struct ur_msgs__srv__SetIO_Event__Sequence
{
  ur_msgs__srv__SetIO_Event * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
