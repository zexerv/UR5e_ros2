 ...
 * Fields without a default value will not be initialized by this function.
 * You might want to call memset(msg, 0, sizeof(
 * ur_msgs__srv__SetIO_Event
 * )) before or use
 * ur_msgs__srv__SetIO_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
bool
ur_msgs__srv__SetIO_Event__init(ur_msgs__srv__SetIO_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
void
ur_msgs__srv__SetIO_Event__fini(ur_msgs__srv__SetIO_Event * msg);

/// Create srv/SetIO message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_msgs__srv__SetIO_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
...
/**
 * It calls
 * ur_msgs__srv__SetIO_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
void
ur_msgs__srv__SetIO_Event__destroy(ur_msgs__srv__SetIO_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
bool
ur_msgs__srv__SetIO_Event__are_equal(const ur_msgs__srv__SetIO_Event * lhs, const ur_msgs__srv__SetIO_Event * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
bool
ur_msgs__srv__SetIO_Event__copy(
  const ur_msgs__srv__SetIO_Event * input,
  ur_msgs__srv__SetIO_Event * output);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
bool
ur_msgs__srv__SetIO_Event__Sequence__init(ur_msgs__srv__SetIO_Event__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
void
ur_msgs__srv__SetIO_Event__Sequence__fini(ur_msgs__srv__SetIO_Event__Sequence * array);

/// Create array of srv/SetIO messages.
/**
 * It allocates the memory for the array and calls
 * ur_msgs__srv__SetIO_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
ur_msgs__srv__SetIO_Event__Sequence *
ur_msgs__srv__SetIO_Event__Sequence__create(size_t size);

/// Destroy array of srv/SetIO messages.
/**
 * It calls
 * ur_msgs__srv__SetIO_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
void
ur_msgs__srv__SetIO_Event__Sequence__destroy(ur_msgs__srv__SetIO_Event__Sequence * array);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
bool
ur_msgs__srv__SetIO_Event__Sequence__are_equal(const ur_msgs__srv__SetIO_Event__Sequence * lhs, const ur_msgs__srv__SetIO_Event__Sequence * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_msgs
bool
ur_msgs__srv__SetIO_Event__Sequence__copy(
  const ur_msgs__srv__SetIO_Event__Sequence * input,
  ur_msgs__srv__SetIO_Event__Sequence * output);
#ifdef __cplusplus
}
#endif
