...
enum
{
  controller_manager_msgs__srv__ListControllers_Event__request__MAX_SIZE = 1
};
// response
enum
{
  controller_manager_msgs__srv__ListControllers_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ListControllers in the package controller_manager_msgs.
typedef struct controller_manager_msgs__srv__ListControllers_Event
{
  service_msgs__msg__ServiceEventInfo info;
  controller_manager_msgs__srv__ListControllers_Request__Sequence request;
  controller_manager_msgs__srv__ListControllers_Response__Sequence response;
} controller_manager_msgs__srv__ListControllers_Event;

// Struct for a sequence of controller_manager_msgs__srv__ListControllers_Event.
typedef struct controller_manager_msgs__srv__ListControllers_Event__Sequence
{
  controller_manager_msgs__srv__ListControllers_Event * data;
  /// The number of valid items in data
  size_t size;
  /// The number of allocated items in data
  size_t capacity;
