...
class Init_SetMode_SendGoal_Event_response
{
public:
  explicit Init_SetMode_SendGoal_Event_response(::ur_dashboard_msgs::action::SetMode_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::ur_dashboard_msgs::action::SetMode_SendGoal_Event response(::ur_dashboard_msgs::action::SetMode_SendGoal_Event::_response_type arg)
  {
...
private:
  ::ur_dashboard_msgs::action::SetMode_SendGoal_Event msg_;
};

class Init_SetMode_SendGoal_Event_request
{
public:
  explicit Init_SetMode_SendGoal_Event_request(::ur_dashboard_msgs::action::SetMode_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_SetMode_SendGoal_Event_response request(::ur_dashboard_msgs::action::SetMode_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetMode_SendGoal_Event_response(msg_);
  }
...
class Init_SetMode_SendGoal_Event_info
{
public:
  Init_SetMode_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetMode_SendGoal_Event_request info(::ur_dashboard_msgs::action::SetMode_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetMode_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::ur_dashboard_msgs::action::SetMode_SendGoal_Event>()
{
  return ur_dashboard_msgs::action::builder::Init_SetMode_SendGoal_Event_info();
}
...
class Init_SetMode_GetResult_Event_response
{
public:
  explicit Init_SetMode_GetResult_Event_response(::ur_dashboard_msgs::action::SetMode_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::ur_dashboard_msgs::action::SetMode_GetResult_Event response(::ur_dashboard_msgs::action::SetMode_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::ur_dashboard_msgs::action::SetMode_GetResult_Event msg_;
};

class Init_SetMode_GetResult_Event_request
{
public:
  explicit Init_SetMode_GetResult_Event_request(::ur_dashboard_msgs::action::SetMode_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_SetMode_GetResult_Event_response request(::ur_dashboard_msgs::action::SetMode_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetMode_GetResult_Event_response(msg_);
  }
...
class Init_SetMode_GetResult_Event_info
{
public:
  Init_SetMode_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetMode_GetResult_Event_request info(::ur_dashboard_msgs::action::SetMode_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetMode_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::ur_dashboard_msgs::action::SetMode_GetResult_Event>()
{
  return ur_dashboard_msgs::action::builder::Init_SetMode_GetResult_Event_info();
}
