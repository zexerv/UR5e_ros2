...
ur_dashboard_msgs__srv__Popup__get_individual_type_description_source(
  const rosidl_service_type_support_t * type_support);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
const rosidl_runtime_c__type_description__TypeSource *
ur_dashboard_msgs__srv__Popup_Request__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
const rosidl_runtime_c__type_description__TypeSource *
ur_dashboard_msgs__srv__Popup_Response__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * )) before or use
 * ur_dashboard_msgs__srv__Popup_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__Popup_Event__init(ur_dashboard_msgs__srv__Popup_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__Popup_Event__fini(ur_dashboard_msgs__srv__Popup_Event * msg);

/// Create srv/Popup message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ur_dashboard_msgs__srv__Popup_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
...
/**
 * It calls
 * ur_dashboard_msgs__srv__Popup_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__Popup_Event__destroy(ur_dashboard_msgs__srv__Popup_Event * msg);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__Popup_Event__are_equal(const ur_dashboard_msgs__srv__Popup_Event * lhs, const ur_dashboard_msgs__srv__Popup_Event * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__Popup_Event__copy(
  const ur_dashboard_msgs__srv__Popup_Event * input,
  ur_dashboard_msgs__srv__Popup_Event * output);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
const rosidl_runtime_c__type_description__TypeSource *
ur_dashboard_msgs__srv__Popup_Event__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__Popup_Event__Sequence__init(ur_dashboard_msgs__srv__Popup_Event__Sequence * array, size_t size);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__Popup_Event__Sequence__fini(ur_dashboard_msgs__srv__Popup_Event__Sequence * array);

/// Create array of srv/Popup messages.
/**
 * It allocates the memory for the array and calls
 * ur_dashboard_msgs__srv__Popup_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
ur_dashboard_msgs__srv__Popup_Event__Sequence *
ur_dashboard_msgs__srv__Popup_Event__Sequence__create(size_t size);

/// Destroy array of srv/Popup messages.
/**
 * It calls
 * ur_dashboard_msgs__srv__Popup_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
void
ur_dashboard_msgs__srv__Popup_Event__Sequence__destroy(ur_dashboard_msgs__srv__Popup_Event__Sequence * array);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__Popup_Event__Sequence__are_equal(const ur_dashboard_msgs__srv__Popup_Event__Sequence * lhs, const ur_dashboard_msgs__srv__Popup_Event__Sequence * rhs);
...
ROSIDL_GENERATOR_C_PUBLIC_ur_dashboard_msgs
bool
ur_dashboard_msgs__srv__Popup_Event__Sequence__copy(
  const ur_dashboard_msgs__srv__Popup_Event__Sequence * input,
  ur_dashboard_msgs__srv__Popup_Event__Sequence * output);
#ifdef __cplusplus
}
#endif
