...
class Init_GetProgramState_Event_response
{
public:
  explicit Init_GetProgramState_Event_response(::ur_dashboard_msgs::srv::GetProgramState_Event & msg)
  : msg_(msg)
  {}
  ::ur_dashboard_msgs::srv::GetProgramState_Event response(::ur_dashboard_msgs::srv::GetProgramState_Event::_response_type arg)
  {
...
private:
  ::ur_dashboard_msgs::srv::GetProgramState_Event msg_;
};

class Init_GetProgramState_Event_request
{
public:
  explicit Init_GetProgramState_Event_request(::ur_dashboard_msgs::srv::GetProgramState_Event & msg)
  : msg_(msg)
  {}
  Init_GetProgramState_Event_response request(::ur_dashboard_msgs::srv::GetProgramState_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetProgramState_Event_response(msg_);
  }
...
class Init_GetProgramState_Event_info
{
public:
  Init_GetProgramState_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetProgramState_Event_request info(::ur_dashboard_msgs::srv::GetProgramState_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetProgramState_Event_request(msg_);
  }
...
template<>
inline
auto build<::ur_dashboard_msgs::srv::GetProgramState_Event>()
{
  return ur_dashboard_msgs::srv::builder::Init_GetProgramState_Event_info();
}
