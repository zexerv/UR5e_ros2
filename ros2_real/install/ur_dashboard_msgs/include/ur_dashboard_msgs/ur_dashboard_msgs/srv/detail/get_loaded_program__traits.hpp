...
inline void to_flow_style_yaml(
  const GetLoadedProgram_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const GetLoadedProgram_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ur_dashboard_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ur_dashboard_msgs::srv::GetLoadedProgram_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ur_dashboard_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ur_dashboard_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const ur_dashboard_msgs::srv::GetLoadedProgram_Event & msg)
{
  return ur_dashboard_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ur_dashboard_msgs::srv::GetLoadedProgram_Event>()
{
  return "ur_dashboard_msgs::srv::GetLoadedProgram_Event";
}

template<>
inline const char * name<ur_dashboard_msgs::srv::GetLoadedProgram_Event>()
{
  return "ur_dashboard_msgs/srv/GetLoadedProgram_Event";
}

template<>
struct has_fixed_size<ur_dashboard_msgs::srv::GetLoadedProgram_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ur_dashboard_msgs::srv::GetLoadedProgram_Event>
  : std::integral_constant<bool, has_bounded_size<service_msgs::msg::ServiceEventInfo>::value && has_bounded_size<ur_dashboard_msgs::srv::GetLoadedProgram_Request>::value && has_bounded_size<ur_dashboard_msgs::srv::GetLoadedProgram_Response>::value> {};

template<>
struct is_message<ur_dashboard_msgs::srv::GetLoadedProgram_Event>
  : std::true_type {};
